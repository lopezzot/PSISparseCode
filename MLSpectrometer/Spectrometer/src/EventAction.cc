...
void EventAction::SetGeneratedSpectrumParameters(G4double mean, G4double sigma)
{
    fGeneratedMean = mean;
...
G4double EventAction::GetGeneratedMean() const
{
    return fGeneratedMean;
}

G4double EventAction::GetGeneratedSigma() const
{
    return fGeneratedSigma;
}
