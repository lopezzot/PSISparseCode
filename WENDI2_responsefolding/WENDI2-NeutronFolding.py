'''
This code was created to calculate the correction of the WENDI-2 neutron detector dose measurement when used in the SwissFell neutron radiation environment.
Specifically the neutron fluence was calculated with FLUKA based on the 2025 measurement campaign at the PSI SwissFell.
Data for the WENDI-2 neutron response come from literature reported below in comments.
'''

# This is the lower side of the energy bins for the neutron flux simulated with FLUKA in 2025 at SwissFELL
...
# This is the upper side of the energy bins for the neutron flux simulated with FLUKA in 2025 at SwissFELL
...
ax_top.set_title('Simulated Neutron Spectrum (SwissFELL) & WENDI-2 Relative Response', fontsize=14, pad=15)
...
# --- GLOBAL BIAS CALCULATION (WENDI-2 Over/Under-response for SwissFELL Neutron Spectrum) ---
